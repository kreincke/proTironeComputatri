...
\printbibliography[keyword={LF10a}, title={Lernfeld 10a: Benutzerschnittstellen gestalten}]
\printbibliography[keyword={LF11a}, title={Lernfeld 11a: Funktionalität in Anwendungen realisieren}]
\printbibliography[keyword={LF12a}, title={Lernfeld 12a: Anwendungen kundenspezifisch entwickln}]
\printbibliography[keyword={LF10b}, title={Lernfeld 10b: Serverdienste bereitstellen und Administration automatisieren}]
\printbibliography[keyword={LF11b}, title={Lernfeld 11b: Betrieb und Sicherheit vernetzter Systeme gewährleisten}]
\printbibliography[keyword={LF12b}, title={Lernfeld 12b: Systeme kundenspezifisch integrieren}]
\printbibliography[keyword={LF10c}, title={Lernfeld 10c: Werkzeuge maschinellen Lernens einsetzen}]
\printbibliography[keyword={LF11c}, title={Lernfeld 11c: Prozesse analysieren und gestalten}]
\printbibliography[keyword={LF12c}, title={Lernfeld 12c: Prozesse und Daten kundenspezifisch analysieren}]
\printbibliography[keyword={LF10d}, title={Lernfeld 10d: Cyber-physische Systeme entwickeln}]
\printbibliography[keyword={LF11d}, title={Lernfeld 11d: Betrieb und Sicherheit vernetzter Systeme gewährleisten}]
\printbibliography[keyword={LF12d}, title={Lernfeld 12d: Cyber-physische Systeme kundenspezifisch optimieren}]
